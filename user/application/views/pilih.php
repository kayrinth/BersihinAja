...
<body>
    ...
    <div class="card text-center">
        ...
        <div class="d-flex justify-content-around mb-4">
            <button class="btn-choice" onclick="location.href='register_customer';">customer</button>
            <button class="btn-choice" onclick="location.href='register_pekerja';">pekerja</button>
        </div>
    </div>
