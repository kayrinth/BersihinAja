...
<div class="container">
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				<th><?php echo $value["nama_beli"] ?></th>
				<th><?php echo number_format($value["harga_beli"]) ?></th>
				<th><?php echo number_format($value["jumlah_beli"]) ?></th>
				<th><?php echo number_format($value["harga_beli"] * $value["jumlah_beli"]) ?></th>
			</tr>
			<?php endforeach ?>
		</tbody>
		<tfoot>
